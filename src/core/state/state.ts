...
/** Event stored in telemetry-events.ndjson and drained by flushTelemetryEvents. */
export interface StoredTelemetryEvent {
  metadata: TelemetryEventMetadataBase;
  event_payload: TelemetryEventIdentityPayload & Record<string, unknown>;
}
...
export interface TelemetryState {
  ...
  /** Legacy events queue. Migrated in post-update. */
