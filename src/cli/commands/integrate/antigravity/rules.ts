...
export const PROMPT_SECRETS_RULE_DESCRIPTION =
  'Refuse user prompts that appear to contain secrets or credentials';
export const SQAA_RULE_DESCRIPTION =
  'Run SonarQube Agentic Analysis on modified files at end-of-turn';

/** Render an Antigravity workspace rule (`.agents/rules/*.md`) with always-on activation. */
export function buildAntigravityAlwaysOnRule(description: string, body: string): string {
...
/** Legacy project instructions path from releases before Rules support. */
