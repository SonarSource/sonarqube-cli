...
/** Root directory for all CLI data: ~/.sonarqube-cli (override via SONAR_CLI_DIR env var in test environment) */
export const CLI_DIR = process.env.SONAR_CLI_DIR ?? join(homedir(), `.${APP_NAME}`);
