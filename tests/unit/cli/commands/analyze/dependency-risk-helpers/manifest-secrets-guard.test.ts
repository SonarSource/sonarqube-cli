...
const secretsModule = await import('../../../../../../src/cli/commands/analyze/secrets.ts');
...
void mock.module('../../../../../../src/cli/commands/analyze/secrets.ts', () => ({
  ...secretsModule,
...
const { preScanManifestsForSecrets } =
  await import('../../../../../../src/cli/commands/analyze/dependency-risk-helpers/manifest-secrets-guard.ts');
