...
const binaryModule = await import('../../../../../../src/cli/commands/_common/install/binary.ts');
...
void mock.module('../../../../../../src/cli/commands/_common/install/binary.ts', () => ({
  ...binaryModule,
...
const { DefaultSecretsInstaller, ResolveOnlySecretsInstaller } =
  await import('../../../../../../src/cli/commands/_common/install/secrets.ts');
