...
describe('OrganizationsClient', () => {
  ...
  describe('getOrganizationId', () => {
    it('hits api.sonarcloud.io, not the serverURL', async () => {
      ...
      await cloudClient.getOrganizationId('my-org').orThrow();
